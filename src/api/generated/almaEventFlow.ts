 ...
 * Alma Event Flow
 * OpenAPI spec version: 0.3.0-beta
 */
...
/**
 * Transport-specific data. Web-push: p256dh, auth.
 */
export type ClientCreatePayload = {[key: string]: string};
 ...
 */
export interface LocationFromAddressCreate {
  address_id: string;
  name?: string | null;
}
 ...
 * collectives by name.
 */
export interface MyCollectiveRead {
  id: string;
  name: string;
  principal_id: string;
  is_verified: boolean;
...
export const getMyCollectivesEventV1MeCollectivesGet = (
 ...
 ): Promise<AxiosResponse<MyCollectiveRead[]>> => {
    return axios.get(
 ...
 * @summary Get My Event Attendance
 */
export const getMyEventAttendanceEventV1MeEventsEventIdAttendanceGet = (
    eventId: string, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<AttendanceRead[]>> => {
    return axios.get(
      `/event/v1/me/events/${eventId}/attendance`,options
    );
  }
 ...
 * @summary Get My Collective Templates
 */
export const getMyCollectiveTemplatesEventV1MeCollectivesCollectiveIdTemplatesGet = (
    collectiveId: string, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<EventRead[]>> => {
    return axios.get(
      `/event/v1/me/collectives/${collectiveId}/templates`,options
    );
  }
 ...
 * @summary Get City
 */
export const getCityGeoV1CitiesCityIdGet = (
    cityId: number, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<CityRead>> => {
    return axios.get(
      `/geo/v1/cities/${cityId}`,options
    );
  }
 ...
 */
export const createLocationFromAddressGeoV1LocationsFromAddressPost = (
    locationFromAddressCreate: LocationFromAddressCreate, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<LocationRead>> => {
    return axios.post(
      `/geo/v1/locations/from-address`,
      locationFromAddressCreate,options
    );
  }
 ...
 * @summary Get Map
 */
export const getMapGeoV1MapGet = (
    params: GetMapGeoV1MapGetParams, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<MapResult>> => {
    return axios.get(
      `/geo/v1/map`,{
    ...options,
        params: {...params, ...options?.params},}
 ...
 */
export const listMyClientsNotifyV1ClientsMyGet = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<ClientRead[]>> => {
    return axios.get(
      `/notify/v1/clients/my`,options
    );
  }

/**
 * Registers a delivery endpoint (e.g. a browser web-push subscription).
 * @summary Register My Client
 */
export const registerMyClientNotifyV1ClientsMyPost = (
    clientCreate: ClientCreate, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<ClientRead>> => {
    return axios.post(
      `/notify/v1/clients/my`,
      clientCreate,options
    );
  }

/**
 * @summary Delete My Client
 */
export const deleteMyClientNotifyV1ClientsMyClientIdDelete = (
    clientId: string, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<unknown>> => {
    return axios.delete(
      `/notify/v1/clients/my/${clientId}`,options
    );
  }
 ...
 */
export const getMyPreferencesNotifyV1PreferencesMyGet = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<PreferencesRead>> => {
    return axios.get(
      `/notify/v1/preferences/my`,options
    );
  }

/**
 * Full replace of preferences. Email is forced on (guaranteed transport).
 * @summary Set My Preferences
 */
export const setMyPreferencesNotifyV1PreferencesMyPut = (
    preferencesUpdate: PreferencesUpdate, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<PreferencesRead>> => {
    return axios.put(
      `/notify/v1/preferences/my`,
      preferencesUpdate,options
    );
  }
 ...
 */
export const sendTestNotificationNotifyV1TestPost = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<SendTestNotificationNotifyV1TestPost200>> => {
    return axios.post(
      `/notify/v1/test`,
      undefined,options
    );
 ...
 */
export const listTransportsNotifyV1TransportsGet = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<TransportInfo[]>> => {
    return axios.get(
      `/notify/v1/transports`,options
    );
  }
 ...
 */
export const getVapidPublicKeyNotifyV1WebpushVapidPublicKeyGet = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<VapidPublicKey>> => {
    return axios.get(
      `/notify/v1/webpush/vapid-public-key`,options
    );
  }
...
export type CancelMyCollectiveParticipationEventV1MeCollectivesCollectiveIdParticipationsEventIdDeleteResult = AxiosResponse<unknown>
export type GetMyEventAttendanceEventV1MeEventsEventIdAttendanceGetResult = AxiosResponse<AttendanceRead[]>
...
export type GetMyCollectiveTemplatesEventV1MeCollectivesCollectiveIdTemplatesGetResult = AxiosResponse<EventRead[]>
...
export type CreateLocationFromAddressGeoV1LocationsFromAddressPostResult = AxiosResponse<LocationRead>
export type GetMapGeoV1MapGetResult = AxiosResponse<MapResult>
export type ListMyClientsNotifyV1ClientsMyGetResult = AxiosResponse<ClientRead[]>
export type RegisterMyClientNotifyV1ClientsMyPostResult = AxiosResponse<ClientRead>
export type DeleteMyClientNotifyV1ClientsMyClientIdDeleteResult = AxiosResponse<unknown>
export type GetMyPreferencesNotifyV1PreferencesMyGetResult = AxiosResponse<PreferencesRead>
export type SetMyPreferencesNotifyV1PreferencesMyPutResult = AxiosResponse<PreferencesRead>
...
export type ListMySessionsUserV1UsersMeSessionsGetResult = AxiosResponse<SessionRead[]>
export type RevokeOtherSessionsUserV1UsersMeSessionsDeleteResult = AxiosResponse<void>
export type RevokeSessionUserV1UsersMeSessionsSessionIdDeleteResult = AxiosResponse<void>
